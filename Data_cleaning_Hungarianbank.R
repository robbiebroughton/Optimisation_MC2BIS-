...
data<- subset(original_data, select=-c(EqualTo,Compound_ID,Unique,REASON_FOR_CLOSURE,DESCRIPTION,AGE_IN_DAYS,CREATION_DATE,LAST_UPDATED,EVENT_DATE,ACTION_NUM, TRANSACTION_ID, TXN_TYPE_DESC, ASSIGNED_TO,ASSIGNED_BY,ORIGINAL_CURRENCY_AMOUNT,ORIGINAL_CURRENCY,CUSTOMER_REGION,POSTAL_CODE,BRANCH_ID,CUSTOMER_BRANCH,COUNTRY_OF_RESIDENCE,BUSINESS_TYPE,ACCOUNT_BALANCE,CREDIT_DEBIT,HOLDING_BANK_NAME,ACCOUNT_BRANCH,BRANCH_CODE,CASE_KEY, CASE_IDENTIFIER,NUM_ALERTS,NUM_CUSTOMERS,CASE_CREATION_DATE,INVESTIGATION_LENGTH,NORKOM_SCORE,TRANSACTION_DATE))
attach(data)
