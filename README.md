...
3) Skim plot describing % of transactions needed to extract % of SAR's from the data by the potential machine learning models can be seen  ![here:](https://github.com/robbiebroughton/Optimisation_MC2BIS-/blob/master/SkimplotCluster3Transaction.png)
